package com.sacbe.coursera.mascotas;
    ...
    public void agregarFAB(){
        ...
        miFAB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                //Toast.makeText(getBaseContext(),getResources().getString(R.string.mensaje_toas1),Toast.LENGTH_SHORT).show();
                Snackbar.make(v,getResources().getString(R.string.mensaje_toas1), Snackbar.LENGTH_SHORT)
                        ...
                        .setActionTextColor(getResources().getColor(R.color.colorOroPuma))
                        .show();
            }
        });
    }
